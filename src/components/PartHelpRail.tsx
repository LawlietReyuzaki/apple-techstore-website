...
const WhatsAppLogo = ({ className = "h-4 w-4" }: { className?: string }) => (
...
/**
 * Slim vertical tab pinned to the right edge of the screen. It follows the user while scrolling:
 * "Can't find the repair part you're looking for?" → WhatsApp number, or Request a part.
 */
export function PartHelpRail() {
  return (
