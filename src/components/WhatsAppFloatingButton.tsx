...
export const WhatsAppFloatingButton = () => {
  ...
  return (
    <>
      ...
      <button
        onClick={handleClick}
        className="fixed bottom-6 left-6 z-50 w-14 h-14 md:w-14 md:h-14 rounded-full flex items-center justify-center shadow-lg transition-transform duration-300 hover:scale-110"
